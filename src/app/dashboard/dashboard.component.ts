...
export class DashboardComponent implements OnInit {
  ...
  sold:SoldGlassesCount
  sonSatislar:GlassesDetailDto[]=[]
  ngOnInit() {
    this.getSoldGlassesCount();
    this.getSonSatislar();
    this.bigChart();
    this.globalSales();
    this.chart();
 ...
 getSonSatislar(){
  this.satisService.getSonSatislar().subscribe(response =>{
    this.sonSatislar = response.data;
  })
 }
...
getSoldGlassesCount(){
  this.satisService.getSoldGlassesCount().subscribe(response =>{
      response.data;
    ...
    this.lineBigDashboardChartData = [
        {
          ...
          borderWidth: 2,
          data: [, 150, 100, 190, 130, 90, 150, 160, 120, 140, 190, 95]
        }
      ];
  ...
  this.lineChartWithNumbersAndGridData = [
      {
        ...
        data: [10 , 500, 650, 700, 1200, 1250, 1300, 1900]
      }
    ];
